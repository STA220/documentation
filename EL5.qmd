...
-   Exceptions nevertheless exist!
    ...
    -   Earlier versions of R relied on system-specific native encodings (notably on Windows), whereas modern versions (R ≥ 4.2) use UTF-8 as the default across platforms.
